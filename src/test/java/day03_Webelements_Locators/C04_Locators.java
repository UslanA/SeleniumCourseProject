...
public class C04_Locators {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement gununFirstalariElemnti = driver.findElement(By.linkText("Günün Fırsatları"));
        gununFirstalariElemnti.click();
        ...
        // acilan ilk sayfada ilk urunu tiklayin

        List<WebElement> firsatUrunlerListesi = driver.findElements(By.className("DealGridItem-module__dealItemContent_1vFddcq1F8pUxM8dd9FW32"));
        /*
        ...
        firsatUrunlerListesi.get(0).click();
